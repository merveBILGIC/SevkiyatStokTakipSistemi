...
namespace SevkiyatStokTakipSistemi.Controllers
{
    public class UserRolesController : Controller
    {
        ...
        public async Task<IActionResult>Index()
        {
            ...
            var usersRoleViewModel = new List<UserRolesViewModel>();
            foreach(AppUser user in users)
            {
                ...
                usersRoleViewModel.Add(thisViewModel);
            }
        ...
        public async Task<IActionResult>Manage(string userId)
        {
            ...
            if(user==null)
            {
                ViewBag.ErrorMessage = $"{userId} ID'li KULLANICI BULUNAMADI!";
            }
        ...
        public async Task<IActionResult>Manage(List<ManageUserRolesViewModel>model,string userId)
        {
            ...
            if (!result.Succeeded)
            {
                ModelState.AddModelError("", "Kullanıcının Rolü Kaldırılamz.");
                return View(model);
            }
            ...
            if(!result.Succeeded)
            {
                ModelState.AddModelError("", "Kullanıcıya secilen Roller eklemez.");
                return View(model);
            }
